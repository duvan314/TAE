...
Todo lo el codigo de este trabajo se encuentra en el repositorio de [Github](https://github.com/duvan314/TAE/tree/main/Trabajo%202), en cada una de las carpetas se encuentran lo siguiente:
